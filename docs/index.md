...
bottom of the sidebar switches between them — an install running 0.11.0 should
read the 0.11.0 pages, because a setting introduced after that tag is not a
