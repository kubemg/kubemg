...
- The management plane image, `KUBEMG_IMAGE`/`KUBEMG_VERSION`
  (`ghcr.io/kubemg/kubemg:0.7.2`) in Compose, or the `image:` field of the
  Deployment in Kubernetes.
- The agent image, `KUBEMG_AGENT_IMAGE` (`ghcr.io/kubemg/kubemg-agent:0.7.2`),
...
running `0.7.2` corresponds to the `0.7.2` version of these docs, not
